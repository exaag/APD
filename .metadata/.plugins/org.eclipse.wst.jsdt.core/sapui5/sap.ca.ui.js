 ...
 * @public
 * @deprecated Since version 1.21.1. 
 * We strongly recommend you to use sap.viz charts instead and to follow the guidelines for
 * the chart toolbar with wave 6 using sap.m controls. All new development will need to be done using sap.viz
 * charts and while existing charts from sap.ca can still be kept they will need to be replaced at a later defined
 * date to the new chart library.
 * This control will not be supported anymore from wave 6 (1.22 branch).
 * 
 */
 ...
 * @deprecated Since version 1.21.1. 
 * This control has been made available in sap.m.
 * Please use sap.m.FeedListItem instead!
 * This control will not be supported anymore.
 * 
 */
 ...
 * @public
 * @deprecated Since version 1.21.1. 
 * PictureViewer was replacing the Carousel as it wasn't supporting some versions of MS
 * Internet Explorer.
